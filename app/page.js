  ...
  return (
    <section className="relative h-screen flex items-center justify-center bg-cover bg-center" style={{backgroundImage: 'url("/placeholder.svg?height=1080&width=1920")'}}>
      ...
      >
        ...
        <Button size="lg" className="bg-red-600 text-white hover:bg-red-700">Start Your Journey</Button>
      </motion.div>
    </section>
  )
}
            ...
            >
              <Card className="h-full flex flex-col bg-white shadow-lg hover:shadow-xl transition-shadow">
                ...
                <CardFooter>
                  ...
                  >
                    {joinedCommunities.includes(community.id) ? 'Request send to  Community' : 'Join Community'}
                  </Button>
                </CardFooter>
              </Card>
            </motion.div>
